...
pair<int, int> bubbleSort(int *input, int size) {
  ...
  ans.second =
      count_comparisons; // second member would store the umber of comparisons.
  return ans;
}
...
int main() {
  ...
  cout << "3 . As both BubbleSort and SelectionSort are In-place algorithms, "
          "hence both of their Inplace Algorithms have been written above."
       << endl;
}
